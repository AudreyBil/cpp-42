...
/*   Updated: 2025/07/23 14:44:17 by abillote         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Dog::Dog(const Dog& other) : Animal(other)
{
	...
	m_brain = new Brain(*other.m_brain); // Deep copy the Brain content instead of pointing to same memory
}
...
Dog& Dog::operator=(const Dog& other)
{
	...
	if (this != &other)
	{
		...
		m_brain = new Brain(*other.m_brain); // Create a new brain && deep copy the content
	}
	return *this;
}
