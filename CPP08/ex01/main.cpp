...
int main() {
    {
        std::cout << CYAN << BOLD << "---Testing simple Span with 5 integers---"
                  << RESET << std::endl;
        Span sp = Span(5);
        sp.addNumber(6);
        sp.addNumber(3);
    ...
    {
        std::cout << CYAN << BOLD
                  << "\n--- Testing 20000 Random Integers with vectors ---"
                  << RESET << std::endl;
        ...
        if (sp.getSize() == 20000)
            std::cout << BOLD << "✓ Successfully added 20000 random integers"
                      << RESET << std::endl;
    ...
    {
        std::cout << CYAN << BOLD
                  << "\n--- Testing 20000 Random Integers with list ---"
                  << RESET << std::endl;
    ...
    {
        std::cout << CYAN << BOLD << "\n---Testing array with 1 int---" << RESET
                  << std::endl;
        Span sp = Span(5);
        sp.addNumber(1);
        try {
    ...
    {
        std::cout << CYAN << BOLD
                  << "\n---Testing addRange with C_style array---" << RESET
                  << std::endl;
    ...
    {
        std::cout << CYAN << BOLD << "\n---Testing storage overflow---" << RESET
                  << std::endl;
    ...
    {
        std::cout << CYAN << BOLD << "---Testing with negative integers---"
                  << RESET << std::endl;
        Span sp = Span(5);
        sp.addNumber(-6);
        sp.addNumber(3);
